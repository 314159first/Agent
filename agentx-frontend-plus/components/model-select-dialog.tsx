...
export function ModelSelectDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex h-[85vh] max-h-[85vh] max-w-5xl flex-col gap-0 overflow-hidden">
        ...
        <Tabs defaultValue="modelSelect" className="mt-4 flex min-h-0 w-full flex-1 flex-col">
          ...
          <TabsContent value="modelSelect" className="min-h-0 flex-1 pt-4">
            {loading ? (
          ...
          <TabsContent value="modelParams" className="min-h-0 flex-1 overflow-y-auto py-4 pr-4">
          ...
          <TabsContent value="tokenStrategy" className="min-h-0 flex-1 overflow-y-auto py-4 pr-4">
            <div>
