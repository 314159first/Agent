...
import { deleteMarketToolWithToast } from "@/lib/tool-service"
...
export default function ToolsPage() {
  ...
  const handleDeleteMarketTool = async (tool: MarketTool) => {
    ...
    if (response.code === 200) {
      setTools((prev: MarketTool[]) => prev.filter(item => (item.toolId || item.id) !== actualToolId));
    }
  };
    ...
    <div className="py-6 min-h-screen bg-gray-50">
      <div className="container max-w-7xl mx-auto px-2">
        ...
        <RecommendedToolsSection
          ...
          onDeleteClick={handleDeleteMarketTool}
        />
