...
import { Download, Info, Trash2, User, Wrench } from "lucide-react";
...
interface MarketToolCardProps {
  ...
  onDeleteClick?: (tool: MarketTool) => void;
}

export function MarketToolCard({ tool, onInstallClick, onDeleteClick }: MarketToolCardProps) {
  return (
